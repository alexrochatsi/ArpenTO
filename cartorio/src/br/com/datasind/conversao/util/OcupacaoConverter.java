...
public class OcupacaoConverter extends ConverterPadrao implements Converter{
   ...
   public Object getAsObject(FacesContext context, UIComponent component, String value) {
	  ...
	  try {
		 ...
		 Ocupacao object=gerente.obterOcupacaoPorId(codigo);
		 return object;
   ...
   public String getAsString(FacesContext arg0, UIComponent component, Object value) {
	  if(value != null && value instanceof Ocupacao) {
		 Ocupacao entity=(Ocupacao) value;
   ...
   protected void addAttribute(UIComponent component, Ocupacao o) {
