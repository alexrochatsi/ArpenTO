...
public class BancoConverter extends ConverterPadrao implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			Banco object = gerente.obterBancoPorId(codigo);
			return object;
	...
	protected void addAttribute(UIComponent component, Banco o) {
