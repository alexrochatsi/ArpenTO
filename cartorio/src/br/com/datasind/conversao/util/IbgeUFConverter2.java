...
@FacesConverter(value = "ibgeUFConverter2", forClass = IbgeUF.class)
public class IbgeUFConverter2 extends ConverterPadrao implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			IbgeUF object = gerente.obterIbgeUFPorId(codigo);
			return object;
	...
	public String getAsString(FacesContext arg0, UIComponent component, Object value) {
		if (value != null && value instanceof IbgeUF) {
		   IbgeUF entity = (IbgeUF) value;
	...
	protected void addAttribute(UIComponent component, IbgeUF o) {
