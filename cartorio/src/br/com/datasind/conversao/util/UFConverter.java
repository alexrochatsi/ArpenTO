...
public class UFConverter extends ConverterPadrao implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			UF object = gerente.obterUFPorId(codigo);
			return object;
	...
	protected void addAttribute(UIComponent component, UF o) {
