...
public class LocalConverter extends ConverterPadrao implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		try {
			...
			Local object = gerente.obterLocalPorId(codigo);
			return object;
	...
	protected void addAttribute(UIComponent component, Local o) {
