   ...
   public void buscarPagamentos() {
	  try {
		 ...
		 if(getTipoPagamento() == 1) {
			setListaPagamentos(gerenteControleAcesso.obterListaPagamentosByCartorioPeriodoPagoNPago(getUsuarioCartorioSessao().getCartorio() , getMes() , getAno() , true));
		 } else if(getTipoPagamento() == 2) {
			setListaPagamentos(gerenteControleAcesso.obterListaPagamentosByCartorioPeriodoPagoNPago(getUsuarioCartorioSessao().getCartorio() , getMes() , getAno() , false));
		 } else {
			setListaPagamentos(gerenteControleAcesso.obterListaPagamentosByCartorioPeriodo(getUsuarioCartorioSessao().getCartorio() , getMes() , getAno()));
		 }
