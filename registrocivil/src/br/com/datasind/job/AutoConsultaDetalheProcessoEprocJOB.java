 ...
 * 
 * @author OsmarJunior
 * @since 13 de nov de 2015
 */

public class AutoConsultaDetalheProcessoEprocJOB implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		if (countJobDetalhe <= 1 && countJobListaProcessos == 0 && countJobMandadosBusca == 0) {// so
																								// executa
																								// se
			ChamaURL chamaURL = new ChamaURL();
			// System.out.println(InfoSingleton.getInstance().getClientesDesatualizados());
			try {
				chamaURL.chamaURL("http://localhost:8080/registrocivil/test/consultaDetalheProcAutentic.jsf");
